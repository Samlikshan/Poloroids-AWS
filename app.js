...
app.use((req, res, next) => {
  if (req.path.startsWith('/admin/auth') || req.path === '/admin/login' || req.path === '/admin/reset-password' || req.path === '/admin/new-password' || req.path === '/admin/forgot-password' || req.path === '/admin/report') {
