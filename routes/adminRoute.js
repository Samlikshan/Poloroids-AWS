...
const {
  ...
  applyCoupon,
  deleteCoupon,
} = require("../controllers/admin/couponManagement");
const {
  viewOffers,
  addOffer,
  getEditOffer,
  postEditOffer,
  deleteOffer,
} = require("../controllers/admin/offerManagement");
const { returnOrder } = require("../controllers/user/orderContoller");
...
const storage = multer.diskStorage({
  destination: (req, file, cb) => {
    cb(null, "../Polaroids-AWS/public/images/products");
  },
...
router.get("/order/:orderId/:itemId", singleOrder);
router.post("/order/return", returnOrder);
